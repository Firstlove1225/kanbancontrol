...
use App\Filament\Resources\JobOrderplResource\Pages;
use App\Filament\Resources\JobOrderplResource\RelationManagers;
use App\Models\JobOrderpl;
use Filament\Forms;
...
class JobOrderplResource extends Resource
{
    protected static ?string $model = JobOrderpl::class;

    protected static ?string $navigationIcon = 'heroicon-o-rectangle-stack';
    protected static ?string $navigationLabel = 'JOB ORDER PL';
    protected static ?string $label =  'JOB ORDER PL';
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                Section::make('JobOrderpl Details')
                    ->schema([
                        Grid::make(2)
                            ->schema([
    ...
    {
        return [
            'index' => Pages\ListJobOrderpls::route('/'),
            'create' => Pages\CreateJobOrderpl::route('/create'),
            'edit' => Pages\EditJobOrderpl::route('/{record}/edit'),
        ];
    }
}
